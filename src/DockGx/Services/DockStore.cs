...
/// <summary>Loads and saves the dock configuration as JSON under %AppData%\DockGx.</summary>
public static class DockStore
{
    private static readonly string Dir =
        Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "DockGx");
